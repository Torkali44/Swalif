...
<div class="home">
  ...
  {{-- Critical CSS inline to ensure correct display on production server regardless of Vite build --}}
  <style>
    .hp-launch-wrap{padding:16px 0;width:100%}
    ...
    <div class="container">
      <div class="launch-offer">
        ...
        <div class="offer-content">
          ...
          @else
            {{-- غير مسجل → يروح لصفحة إنشاء الحساب أولاً --}}
