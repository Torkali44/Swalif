    ...
    >
      ...
      <div class="setup-modal-cols">
        ...
        <div class="setup-modal-col">
          <h3>الفريق الأول</h3>
          <input name="team_one" class="setup-modal-input" placeholder="الفريق الأول" value="{{ old('team_one') }}">
        ...
        <div class="setup-modal-col">
          <h3>الفريق الثاني</h3>
          <input name="team_two" class="setup-modal-input" placeholder="الفريق الثاني" value="{{ old('team_two') }}">
          <div class="setup-modal-counter">
            <button type="button" class="counter-btn minus">—</button>
            <span class="counter-val">1</span>
            <button type="button" class="counter-btn plus">+</button>
