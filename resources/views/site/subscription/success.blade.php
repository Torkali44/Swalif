  ...
  <section class="hp-hero subscribe-hero">
    ...
    <div class="container" style="max-width: 640px; margin: 0 auto;">
      <div class="panel" style="margin-top: 36px; padding: 40px 28px; text-align: center; border-radius: 28px; background: rgba(255,255,255,0.98); box-shadow: 0 20px 50px rgba(0,200,83,0.15); border: 2px solid rgba(0,200,83,0.25);">
        ...
        <div style="background: rgba(0,200,83,0.06); border: 1px solid rgba(0,200,83,0.2); border-radius: 18px; padding: 20px; margin-bottom: 28px; text-align: right;">
        ...
        <a href="{{ route('home') }}" class="btn btn--primary btn--block" style="padding: 16px 28px; font-size: 18px; font-weight: 900; border-radius: 50px; text-decoration: none; box-shadow: 0 10px 25px rgba(0,200,83,0.3);">
          🚀 ابدأ اللعب الآن
        </a>
