@php
  ...
  $winnerRow = $winner
    ...
    : null;
  $winnerCorrect = $winnerRow ? ($winnerRow['correct'] ?? 0) : 0;
  $winnerWrong = $winnerRow ? ($winnerRow['wrong'] ?? 0) : 0;
...
>
  <header class="result-top">
    ...
    <div class="result-top__actions">
      ...
      <a class="result-top__link" href="{{ route('custom-game.create') }}">لعبة جديدة</a>
    </div>
  </header>
        ...
        <div class="team-card__main">
          ...
          <div class="team-card__info">
            ...
            <div class="team-card__stats">
              <span class="stat stat--correct">✔ {{ $row['correct'] ?? 0 }} صحيحة</span>
              <span class="stat stat--wrong">✕ {{ $row['wrong'] ?? 0 }} خاطئة</span>
            </div>
          </div>
  ...
  <section class="actions">
    <a class="btn btn--fire btn--lg" href="{{ route('custom-game.create') }}">🔁 لعبة خاصة جديدة</a>
